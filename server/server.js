...
// Middleware
app.use(cors({
  origin: ['https://rma-system-one.vercel.app', 'https://rma-system-i7n0jiut0-sank-sinhas-projects.vercel.app', 'http://localhost:5173', 'http://localhost:3000'],
  credentials: true
}));
...
db.serialize(() => {
  // RMA records table
  db.run(`CREATE TABLE IF NOT EXISTS rma_records (
...
// Get all RMA records
app.get('/api/rma-records', (req, res) => {
